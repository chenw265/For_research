...
setwd("E:\\My_projects\\LUSC\\15nomo")     #修改工作目录
...
plot(cal, xlim=c(0,1), ylim=c(0,1), xlab="Nomogram-predicted OS (%)", ylab="Observed OS (%)", lwd=2, col="#42B540FF", sub=F)
...
plot(cal, xlim=c(0,1), ylim=c(0,1), xlab="", ylab="", lwd=2, col="#00468BFF", sub=F, add=T)
#5年校准曲线
...
plot(cal, xlim=c(0,1), ylim=c(0,1), xlab="", ylab="", lwd=2, col="#ED0000FF", sub=F, add=T)
legend('bottomright', c('1-year','3-year', '5-year'),
	   col=c("#42B540FF","#00468BFF","#ED0000FF"), lwd=1.5, bty = 'n')
dev.off()
